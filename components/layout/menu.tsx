...
export const Services = () => (
  <Fragment>
    <li>
      <Link href={`${rtl()}services/web-design`}>Web Design</Link>
    </li>
    <li>
      <Link href={`${rtl()}services/seo`}>Search Engine Optimisation</Link>
    </li>
    <li>
      <Link href={`${rtl()}services/cms`}>Content Management Services</Link>
    </li>
  </Fragment>
);
export const Works = () => (
